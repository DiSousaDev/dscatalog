...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<UserDto> save(@RequestBody UserInsertDto user) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserDto> update(@PathVariable Long id, @RequestBody UserUpdateDto user) {
